...
To recall the example from the [Simple Material](gltfTutorial_011_SimpleMaterial.md) section, here is an excerpt of the  JSON part that encodes this information:
